...
However, the raspberry pi display had low fps so her blinking was quite unnatural. In order to solve this problem, we changed some configurations in the raspberry pi. Refer to this video and you could find out how to make it. <cite><a href="https://www.youtube.com/watch?v=cQvC-UI2vQY">Wikipedia</a></cite> 
 
<video width = "450" muted autoplay controls>
    <source src="/assets/img/smartbot/dsip_better.mp4" type="video/mp4">
</video>
